...
final class CroppedImageHelperTests: XCTestCase {
    ...
    func testNilCropRectReturnsOriginal() throws {
        ...
        let result = CroppedImageHelper.croppedImage(from: original, cropRect: nil, imageName: "test")
    ...
    func testIdentityCropReturnsOriginal() throws {
        ...
        let result = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "test")
    ...
    func testCachedResultReturnedOnSecondCall() throws {
        ...
        let first = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "cached-test")
        let second = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "cached-test")
    ...
    func testDifferentImageNamesProduceSeparateCacheEntries() throws {
        ...
        let resultA = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "imageA")
        let resultB = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "imageB")
    ...
    func testCacheInvalidationClearsCache() throws {
        ...
        let before = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "inv-test")
        CroppedImageHelper.invalidateCache()
        let after = CroppedImageHelper.croppedImage(from: original, cropRect: crop, imageName: "inv-test")
