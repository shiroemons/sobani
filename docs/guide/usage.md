...
- **「登録画像」**: 図A と同様に、無効化されたセクションヘッダーの下に個別の画像名が並びます。「登録画像を削除」サブメニューも同じ構造です。
...
| キー | 動作 | コンテキスト |
|------|------|------------|
| `d` | デフォルト画像に戻す | 右クリックメニュー（サブメニュー内） |
| `o` | 画像を変更 | 右クリックメニュー（サブメニュー内） |
| `n` | 新しいウィンドウを開く | 右クリックメニュー（サブメニュー内） |
